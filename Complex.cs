...
public class Complex
{
    ...
    {
        return new Complex(Math.Round(a.Real), Math.Round(a.Imaginal));
    }
    ...
    public Complex Round(int decimals = 0)
    {
        return new Complex(Math.Round(Real, decimals), Math.Round(Imaginal, decimals));
    }
